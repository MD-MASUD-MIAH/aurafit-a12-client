        ...
        ? ReactDOM.createPortal(
            ...
            >
              ...
              <div data-aos="zoom-in"
                className="flex w-11/12 mt-40 lg:mt-0 lg:w-1/2 mx-auto flex-col gap-4 overflow-hidden rounded bg-white p-10 text-slate-500 shadow-xl shadow-slate-700/10"
                id="modal"
                role="document"
              >
                {/* Modal header */}
