...
const AlltrainerCard = ({ trainerData }) => {
  return (
    <div className="overflow-hidden rounded bg-white text-slate-500 shadow-md shadow-slate-200">
      ...
      <div className="p-6">
        ...
        {/* Social Media Links */}
        {trainerData.socialLinks && (
          <div className="mb-4 flex gap-3 mt-2">
            <h4 className=" font-medium text-slate-600  mb-2">Connect :</h4>
            <div className="flex gap-3">
              ...
              {trainerData.socialLinks.twitter && (
                <a
                  href={trainerData.socialLinks.twitter}
                  target="_blank"
                  rel="noopener noreferrer"
              ...
              {trainerData.socialLinks.linkedin && (
                <a
                  href={trainerData.socialLinks.linkedin}
                  target="_blank"
                  rel="noopener noreferrer"
